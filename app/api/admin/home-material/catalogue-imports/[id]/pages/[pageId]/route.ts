 ...
 * discards the candidate without creating anything. Both are terminal —
 * an already-approved/rejected page can't be re-reviewed here; fix the
 * resulting product directly instead (PATCH /api/admin/home-material/
 * products/[id]) to avoid ever double-creating a product for one page.
 */
