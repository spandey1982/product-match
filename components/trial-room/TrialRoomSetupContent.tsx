...
interface Props {
  /** Called after the user confirms a photo — use to close modal or navigate. */
  onComplete?: () => void;
    ...
    <div className="max-w-md mx-auto">
      ...
      <div className="bg-white border border-gray-100 rounded-3xl p-6 shadow-sm space-y-5">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-1.5">
              {PHOTO_TIPS.map(({ label }) => (
                <div key={label} className="flex items-center gap-2 p-2 bg-emerald-50 rounded-xl">
          ...
          >
            ...
            <div className="w-full grid grid-cols-2 gap-1.5">
              {PHOTO_TIPS.map(({ icon: Icon, label }) => (
                <div key={label} className="flex items-center gap-2 p-2 bg-gray-50 rounded-xl">
        ...
        <div className="space-y-2">
          ...
          {onCancel && !staged && !isPhotoActive && (
            <button
              onClick={onCancel}
              className="w-full flex items-center justify-center gap-2 py-2.5 rounded-2xl text-sm text-gray-400 hover:text-gray-600 hover:bg-gray-50 transition-colors"
            >
              Cancel
            </button>
          )}
      ...
      <div className="mt-4 flex items-start gap-2 px-1">
        ...
        <p className="text-xs text-gray-400 leading-relaxed">
          Your photo is used only to generate try-on previews during this session. It is never
